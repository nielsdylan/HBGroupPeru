    ...
    <div class="page-inner">
        <div class="page-header animated fadeInUp">
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="{{route('group.new')}}">Nuevo grupo</a>
                </li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card animated fadeInUp">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('group.add') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="decription" id="decription" cols="30" rows="5" required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
