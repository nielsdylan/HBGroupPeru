...
<head>
  ...
  <style type="text/css">
    ...
    .emailButton{background-color:#d90102; border-collapse:separate;}
...
<body bgcolor="#E1E1E1" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
  ...
  -->
  <center style="background-color:#E1E1E1;padding-bottom:40px;">
      ...
      <tr>
        <td align="center" valign="top" id="bodyCell">
          ...
          <!--
            ...
            that spans the width of the page.
          -->
          <table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody" style="padding-bottom: 25px;">
