...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{route('asignatura.index')}}">Asignatura</a>
            </li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Lista de asignatura</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Editar {{$item->name}}" data-edit="modal" data-id="{{$item->asignature_id }}">
                                                        <i class="fa fa-edit"></i>
                                                    </button>
                                                    <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Eliminar {{$item->name}}" data-delete="modal" data-id="{{$item->asignature_id }}">
...
<script>
    ...
    $(document).on('click','[data-edit="modal"]',function () {
        ...
        var id = $(this).attr('data-id'),
            route = '{{ route('asignatura.edit', ['asignatura' => '+id+'] ) }}';
    ...
    $(document).on('click','[data-delete="modal"]',function () {
        var id = $(this).attr('data-id'),
            route = '{{ route('asignatura.destroy', ['asignatura' => 'id'] ) }}';
            route = route.replace('id', id);
        swal({
