    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header no-bd">
                ...
                <form action="{{route('cursos.store')}}" method="POST" data-form="form-edit">
...
<script>
    $(document).on('submit','[data-form="form-edit"]',function (e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            beforeSend: function()
            {
                $('[data-form="form-edit"] .modal-footer button[type="submit"]').addClass('is-loading')
            },
        }).done(function (response) {
            $('[data-form="form-edit"] .modal-footer button[type="submit"]').removeClass('is-loading');
