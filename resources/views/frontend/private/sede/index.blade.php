...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{route('sede.index')}}">Lista de sedes</a>
            </li>
        </ul>
    </div>
    <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Editar sede({{$item->name}})" data-id="{{$item->sede_id}}" data-edit="modal">
                                                    <i class="fa fa-edit"></i>
                                                </button>
                                                <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Eliminar sede({{$item->name}})" data-id="{{$item->sede_id}}" data-destroy="destroy-sede" >
...
<!-- Modal -->
@include('frontend.private.sede.create')
@include('frontend.private.sede.edit')
@endsection
