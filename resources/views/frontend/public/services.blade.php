                        ...
                        <div class="card-body card-color">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="{{ asset('uploads/public/seguridad.png')}}" alt="">
                                </div>
                                <div class="col-md-8">
                                    <h5>
                ...
                <div class="col-md-6">
                    <div class="card border-card  mt-5 mb-5">
                        <div class="card-body card-color">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="{{ asset('uploads/public/maritima.png')}}" alt="">
                                </div>
                                <div class="col-md-8">
                                    <h5>
                ...
                <div class="col-md-6">
                    <div class="card border-card  mt-5 mb-5">
                        <div class="card-body card-color">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="{{ asset('uploads/public/minera.png')}}" alt="">
                                </div>
                                <div class="col-md-8 ">
                                    <h5>
                ...
                <div class="col-md-6">
                    <div class="card border-card  mt-5 mb-5">
                        <div class="card-body card-color">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="{{ asset('uploads/public/emergencia.png')}}" alt="">
                                </div>
                                <div class="col-md-8">
                                    <h5>
                ...
                <div class="col-md-6">
                    <div class="card border-card  mt-5 mb-5">
                        <div class="card-body card-color">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="{{ asset('uploads/public/calidad.png')}}" alt="">
                                </div>
                                <div class="col-md-8">
                                    <h5>
                ...
                <div class="col-md-6">
                    <div class="card border-card  mt-5 mb-5">
                        <div class="card-body card-color">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="{{ asset('uploads/public/ambiental.png')}}" alt="">
                                </div>
                                <div class="col-md-8">
                                    <h5>
                ...
                <div class="col-md-6">
                    <div class="card border-card  mt-5 mb-5">
                        <div class="card-body card-color">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="{{ asset('uploads/public/proteccion.png')}}" alt="">
                                </div>
                                <div class="col-md-8">
                                    <h5>
                ...
                <div class="col-md-6">
                    <div class="card border-card  mt-5 mb-5">
                        <div class="card-body card-color">
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="{{ asset('uploads/public/otros.png')}}" alt="">
                                </div>
                                <div class="col-md-8">
                                    <h5>
                                        Otros servicios
