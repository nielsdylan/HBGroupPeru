                ...
                <div class="col-md-12">
                    <div class="slider_card owl-carousel">
                        <div class="img-content-two">
                            <div class="card border-card">
                                <div class="card-body card-slider">
                                    <a  class="fancybox" rel="galeria1" href="{{asset('uploads/slider/us_img_sl2_1.jpg')}}">
                        ...
                        <div class="img-content">
                            <div class="card border-card">
                                <div class="card-body card-slider">
                                    <a  class="fancybox" rel="galeria1" href="{{asset('uploads/slider/us_img_sl2_2.jpg')}}">
                                    <div class="card-box" style="
                        ...
                        <div class="img-content">
                            <div class="card border-card">
                                <div class="card-body card-slider">
                                    <a  class="fancybox" rel="galeria1" href="{{asset('uploads/slider/us_img_sl2_3.jpg')}}">
                                    <div class="card-box" style="
                        ...
                        <div class="img-content">
                            <div class="card border-card">
                                <div class="card-body card-slider">
                                    <a  class="fancybox" rel="galeria1" href="{{asset('uploads/slider/us_img_sl2_4.jpg')}}">
                                    <div class="card-box" style="
                        ...
                        <div class="img-content">
                            <div class="card border-card">
                                <div class="card-body card-slider">
                                    <a  class="fancybox" rel="galeria1" href="{{asset('uploads/slider/us_img_sl2_5.jpg')}}">
                                    <div class="card-box" style="
                        ...
                        <div class="img-content">
                            <div class="card border-card">
                                <div class="card-body card-slider">
                                    <a  class="fancybox" rel="galeria1" href="{{asset('uploads/slider/us_img_sl2_6.jpg')}}">
                                    <div class="card-box" style="
                        ...
                        <div class="img-content">
                            <div class="card border-card">
                                <div class="card-body card-slider">
                                    <a  class="fancybox" rel="galeria1" href="{{asset('uploads/slider/us_img_sl2_7.jpg')}}">
                                    <div class="card-box" style="
